    ...
    return Column(
      children: [
        Expanded(
          child: DataTable2(
            columns: [
              DataColumn2(label: Text(l10n.transactionType), size: ColumnSize.L),
              DataColumn2(label: const Text('Count'), size: ColumnSize.M, numeric: true),
              DataColumn2(label: Text(l10n.totalValue), size: ColumnSize.M, numeric: true),
            ],
            rows: types.map((type) {
