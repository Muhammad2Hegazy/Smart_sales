          ...
          child: Container(
            ...
            child: DataTable2(
              ...
              columns: [
                ...
                DataColumn2(
                  label: const Text('Total Purchases', style: TextStyle(fontWeight: FontWeight.bold)),
                  size: ColumnSize.M,
                  numeric: true,
                ),
                DataColumn2(
                  label: const Text('Paid', style: TextStyle(fontWeight: FontWeight.bold)),
                  size: ColumnSize.M,
                  numeric: true,
                ),
                DataColumn2(
                  label: const Text('Unpaid', style: TextStyle(fontWeight: FontWeight.bold)),
                  size: ColumnSize.M,
                  numeric: true,
                ),
              ],
